        ...
        if (list != null)
        {
            for (int i = 0; i < list.Count;)
            {
                ...
                if (del != null)
                {
                    ...
                    {
                        if (del.mTarget != null && del.mMethodName != null)
                        {
                            string ObjName = del.mTarget.name + ":" + del.mMethodName;

                            if (ex.InnerException != null)
                                Debug.LogError(ObjName + ex.InnerException.Message);
                            else
                                Debug.LogError(ObjName + " : " + ex.StackTrace + " : " + ex.Message);
                        }
                    }
                    ...
                    catch (System.Exception ex)
                    {
                        ...
                        if (ex.InnerException != null)
                            ...
                            Debug.LogError(ObjName + ex.Message);
                    }

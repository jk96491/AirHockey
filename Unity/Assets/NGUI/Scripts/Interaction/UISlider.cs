...
public class UISlider : UIProgressBar
{
    ...
    //    get
    //    {
    //        if (mValue > MainLobbyUIDefine.SliderOnValue || mValue >= .5f)
    //            mValue = MainLobbyUIDefine.SliderOnValue;
    //        else if (mValue < MainLobbyUIDefine.SliderOffValue || mValue < .5f)
    //            mValue = MainLobbyUIDefine.SliderOffValue;
    ...
    protected void OnPressBackground(GameObject go, bool isPressed)
    {
        ...
        {
            //if (value > UIDefine.SliderOnValue || value >= .5f)
            //    value = UIDefine.SliderOnValue;
            //else if (mValue < UIDefine.SliderOffValue || value < .5f)
            //    value = UIDefine.SliderOffValue;

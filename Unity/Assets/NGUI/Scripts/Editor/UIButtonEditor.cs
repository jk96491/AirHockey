...
public class UIButtonEditor : UIButtonColorEditor
{
    ...
    {
        NGUIEditorTools.DrawProperty("ScaleOnClick", serializedObject, "enableScaleOnClick");
        NGUIEditorTools.DrawProperty("ScaleParent", serializedObject, "scaleParentObj");
        NGUIEditorTools.DrawProperty("EnableCooldown", serializedObject, "enableCooldown");
